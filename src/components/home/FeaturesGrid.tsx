            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-4">
                  <div
                    className={`inline-flex p-3 rounded-full bg-muted group-hover:bg-accent transition-colors mb-4 ${feature.color}`}
                  >
                    <Icon className="w-6 h-6" aria-hidden="true" />
                  </div>
                  <CardTitle className="text-lg font-semibold text-foreground group-hover:text-red-600 transition-colors">
                    {feature.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full group-hover:bg-red-50 group-hover:border-red-200 dark:group-hover:bg-red-950/30"
                  >
                    <Link to={feature.href}>Explore Tool</Link>
                  </Button>
                </CardContent>
              </Card>
            );
